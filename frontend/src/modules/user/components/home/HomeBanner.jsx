...
const HomeBanner = ({ banner }) => {
    ...
    if (banner.type === 'hero') {
        ...
        return (
            <section className="w-full mt-2 md:mt-4 px-2 md:px-4">
                <div 
    ...
    if (banner.type === 'card') {
        return (
            <section className="w-full mt-4 md:mt-6 px-2 md:px-4">
                <div 
                    onClick={handleBannerContentClick}
    ...
    if (banner.type === 'product_feature') {
        return (
            <section className="w-full mt-2 md:mt-8 px-2 md:px-4">
    ...
    if (banner.type === 'slides' && banner.slides?.length > 0) {
        return (
            <section className="w-full mt-2 md:mt-6 px-2 md:px-4">
                <Swiper
