...
const Account = () => {
    ...
    return (
        <div className="bg-background-light dark:bg-background-dark min-h-screen pb-20 md:pb-8">
            <div className="max-w-[1440px] mx-auto md:px-4 md:pt-4">
                <div className="flex flex-col md:grid md:grid-cols-12 md:gap-4 items-start">
                    ...
                    <div className="hidden md:block md:col-span-4 lg:col-span-3 space-y-4">
                        {/* Identity Card */}
                        <div className="bg-white dark:bg-zinc-900 p-3 rounded-lg shadow-sm flex items-center gap-3 border border-gray-100 dark:border-zinc-800">
                        ...
                        <div className="bg-white dark:bg-zinc-900 rounded-lg shadow-sm overflow-hidden border border-gray-100 dark:border-zinc-800">

                            {/* MY ORDERS */}
                            <div
                                onClick={() => navigate('/my-orders')}
                                className="px-4 py-4 flex items-center justify-between border-b border-gray-100 dark:border-zinc-800 cursor-pointer hover:bg-blue-50 dark:hover:bg-zinc-800 transition-colors group"
                            >
                                <div className="flex items-center gap-3 text-gray-600 dark:text-gray-300 font-bold group-hover:text-blue-600">
                            ...
                            <div className="border-b border-gray-100 dark:border-zinc-800">
                                ...
                                <div className="text-sm">
                                    <div onClick={() => navigate('/addresses')} className="px-12 py-3 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-zinc-800 cursor-pointer">
                                        Saved Addresses
                                    </div>
                                    <div onClick={() => navigate('/select-language')} className="px-12 py-3 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-zinc-800 cursor-pointer">
                                        Select Language
                                    </div>
                                    <div onClick={() => navigate('/notification-settings')} className="px-12 py-3 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-zinc-800 cursor-pointer">
                            ...
                            <div className="border-b border-gray-100 dark:border-zinc-800">
                                ...
                                <div className="text-sm">
                                    <div onClick={() => navigate('/wishlist')} className="px-12 py-3 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-zinc-800 cursor-pointer">
                                        My Wishlist
                                    </div>
                                    <div onClick={() => navigate('/coupons')} className="px-12 py-3 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-zinc-800 cursor-pointer">
                                        My Coupons
                                    </div>
                                    <div onClick={() => navigate('/help-center')} className="px-12 py-3 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-zinc-800 cursor-pointer">
                                        Help Center
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="border-b border-gray-100 dark:border-zinc-800">
                                ...
                                <div className="text-sm">
                                    <div className="px-12 py-3 text-gray-700 dark:text-gray-300 cursor-default flex flex-col">
                            ...
                            <div className="py-2">
                                <div
                                    ...
                                    className="flex items-center gap-3 px-4 py-3 text-gray-600 dark:text-gray-300 font-semibold hover:bg-gray-50 dark:hover:bg-zinc-800 cursor-pointer transition-colors"
                                >
                    ...
                    <div className="w-full md:col-span-8 lg:col-span-9 md:bg-white md:dark:bg-zinc-900 md:rounded-lg md:shadow-sm md:border md:border-gray-100 md:dark:border-zinc-800 overflow-hidden">
                        {/* Matches existing Profile Section logic but desktop adapted container */}
                        <div className="bg-white dark:bg-zinc-900 px-4 py-6 md:p-8">
                            {/* Desktop Header for Profile Form */}
                            <div className="hidden md:flex items-center gap-4 mb-8">
                                <span className="text-lg font-bold text-gray-800 dark:text-white">Personal Information</span>
                                <button
                            ...
                            {!isEditing ? (
                                <div className="flex items-center justify-between">
                                    ...
                                    <button
                                        ...
                                        className="md:hidden px-4 py-1.5 border border-primary text-primary text-sm font-semibold rounded hover:bg-blue-50 dark:hover:bg-blue-900/10 transition-colors"
                                    >
                                        Edit
                                    </button>
                                </div>
                        ...
                        <div className="hidden md:block px-8 py-4 bg-gray-50 dark:bg-zinc-800/50 border-t border-gray-100 dark:border-zinc-800 text-xs text-gray-500 font-medium">
                            FAQs?
                        </div>
                    </div>
                    ...
                    <div className="md:hidden w-full space-y-2 mt-2">
                        {/* Quick Links Grid */}
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-[1px] bg-gray-200 dark:bg-zinc-800 mb-2">
                            <button
                                onClick={() => navigate('/my-orders')}
